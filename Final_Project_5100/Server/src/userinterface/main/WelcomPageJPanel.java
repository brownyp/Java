...
//        System.out.println(aa[4]);
        ...
        lblP1.setIcon(Util.FillLabel(tempP.get(0).getImagePath()));
        lblP2.setIcon(Util.FillLabel(tempP.get(1).getImagePath()));
        lblP3.setIcon(Util.FillLabel(tempP.get(2).getImagePath()));
        lblP4.setIcon(Util.FillLabel(tempP.get(3).getImagePath()));
    ...
    private void btnRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshActionPerformed
        // TODO add your handling code here:
        if ((btnP1.getText().equals(tempP.get(8).getProductName())) || btnP1.getText().equals("P1")) {
            lblP1.setIcon(Util.FillLabel(tempP.get(0).getImagePath()));
            lblP2.setIcon(Util.FillLabel(tempP.get(1).getImagePath()));
            lblP3.setIcon(Util.FillLabel(tempP.get(2).getImagePath()));
            lblP4.setIcon(Util.FillLabel(tempP.get(3).getImagePath()));
            ...
            lblP4.setToolTipText(tempP.get(3).getImagePath());
            return;
        } else if (btnP1.getText().equals(tempP.get(0).getProductName())) {
            lblP1.setIcon(Util.FillLabel(tempP.get(4).getImagePath()));
            lblP2.setIcon(Util.FillLabel(tempP.get(5).getImagePath()));
            lblP3.setIcon(Util.FillLabel(tempP.get(6).getImagePath()));
            lblP4.setIcon(Util.FillLabel(tempP.get(7).getImagePath()));
        ...
        } else if (btnP1.getText().equals(tempP.get(4).getProductName())) {
            lblP1.setIcon(Util.FillLabel(tempP.get(8).getImagePath()));
            lblP2.setIcon(Util.FillLabel(tempP.get(9).getImagePath()));
            lblP3.setIcon(Util.FillLabel(tempP.get(10).getImagePath()));
            lblP4.setIcon(Util.FillLabel(tempP.get(11).getImagePath()));
