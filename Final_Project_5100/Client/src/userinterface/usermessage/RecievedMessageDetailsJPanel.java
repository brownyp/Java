 ...
 * @author kkkevinxx
 */
public class RecievedMessageDetailsJPanel extends javax.swing.JPanel {
    ...
    public RecievedMessageDetailsJPanel(JPanel userProcessContainer, Message message, EcoSystem system) {
        initComponents();
...
//        System.out.println(tempM.get(1).getContent());
        ...
        populateTextArea();
        if (message.getContent().equals("Item delivered!\nDo not reply this message") || message.getContent().equals("Your item is on the way!\nDo not reply this message") || message.getContent().equals("You got an order!\nPlease check it!\nDo not reply this message")) {
    ...
    public void populateTextArea() {
        ...
        if (message.getResponseM() != null) {
            insertDocument(message.getResponseM().getSender().getUsername() + " " + message.getResponseM().getSentTime()
                    + "\n", message.getResponseM().getSender().equals(message.getReceiver()) ? Color.GREEN : Color.BLUE);
    ...
    private void initComponents() {
        ...
        txtMessageDetails.setEditable(false);
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        ...
        UserAccount sender = mt.getReceiver();
        UserAccount recevier = mt.getSender();
        ...
        insertDocument(mt.getReceiver().getUsername() + " " + sentTime + "\n", Color.GREEN);
        ...
        try {
            ...
            Logger.getLogger(RecievedMessageDetailsJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
