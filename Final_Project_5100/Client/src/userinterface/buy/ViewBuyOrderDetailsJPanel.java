...
import userinterface.Logistic.PackageTracingJPanel;
...
public class ViewBuyOrderDetailsJPanel extends javax.swing.JPanel {
    ...
    public ViewBuyOrderDetailsJPanel(JPanel userProcessContainer, UserAccount userAccount, Order order, EcoSystem system) {
        initComponents();
        ...
        lblImage.setIcon(Util.FillLabelBig(order.getProduct().getImagePath()));
        lblCategory.setText(order.getProduct().getCatagory());
        lblRating.setText(String.valueOf(order.getRating()).equals("0") ? "N/A" : String.valueOf(order.getRating()));
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(27, 27, 27))
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(lblSellerName, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGotitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGotitActionPerformed
        ...
        if (!order.getExpress().equals("N/A (Face to Face)")) {
            ...
            try {
                ...
                Logger.getLogger(ViewBuyOrderDetailsJPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            order.setOrderStatus("Delivered");
            btnGotit.setEnabled(false);
    ...
    private void btnTrackOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTrackOrderActionPerformed
           int num=Integer.parseInt(order.getTrackingNum());
           
           for(Package p:system.getFps().getFedexPackageDirectory()){
               if (num==p.getTrackingNum()) {
                    PackageTracingJPanel packageTracingJPanel=new PackageTracingJPanel(system,userProcessContainer,order,p,userAccount);
                    userProcessContainer.add("PackageTracingJPanel",packageTracingJPanel);
                    CardLayout layout=(CardLayout)userProcessContainer.getLayout();
            ...
            for(Package p1: system.getUps().getUspsPackageDirectory()){
                    if (num==p1.getTrackingNum()){
                        PackageTracingJPanel packageTracingJPanel=new PackageTracingJPanel(system,userProcessContainer,order,p1,userAccount);
                        userProcessContainer.add("PackageTracingJPanel",packageTracingJPanel);
                        CardLayout layout=(CardLayout)userProcessContainer.getLayout();
                        layout.next(userProcessContainer);
                    }
