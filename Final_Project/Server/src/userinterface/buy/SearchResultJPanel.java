...
public class SearchResultJPanel extends javax.swing.JPanel {
                    ...
                    for (Enterprise e : c.getEnterpriseDirectory().getEnterpriseList()) {
                        for (Organization o : e.getOrganizationDirectory().getOrganizationList()) {
                            ...
                            for (Product p : o.getProductDirectory().getProductList()) {
                                ...
                                if (!p.getUserAccount().equals(userAccount) && p.getCatagory().equals(category.getValue())) {
                                    Object[] row = new Object[6];
                                    row[0] = p;
                                    row[1] = p.getUserAccount().getPerson().getCountry() + "." + p.getUserAccount().getPerson().getState() + "." + p.getUserAccount().getPerson().getCity();
    ...
    private void initComponents() {
        ...
        cbSort.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Price low to high", "Price high to low" }));
        ...
        tblResult.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Name", "Location", "Price", "Status", "Seller", "School"
            }
        ) {
...
//        welcomPageJPanel.populateAmount();
    ...
    private void cbSortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSortActionPerformed
        ...
        if (cbSort.getSelectedItem().equals("Price low to high")) {
            populateTable();
        } else if (cbSort.getSelectedItem().equals("Price high to low")) {
            DefaultTableModel model = (DefaultTableModel) tblResult.getModel();
            model.setRowCount(0);
