...
public class AllSentMessagesJPanel extends javax.swing.JPanel {
    ...
    public AllSentMessagesJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization) {
        initComponents();
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            SentMessageDetailsJPanel sentMessageDetailsJPanel = new SentMessageDetailsJPanel(userProcessContainer, message);
