...
public class SentMessageDetailsJPanel extends javax.swing.JPanel {
    ...
    EcoSystem system;
    Util Util = new Util();
    public SentMessageDetailsJPanel(JPanel userProcessContainer, Message message, EcoSystem system) {
        initComponents();
...
//        System.out.println(tempM.get(1).getContent());
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        ...
        try {
            ...
            Logger.getLogger(SentMessageDetailsJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
